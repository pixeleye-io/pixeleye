...
describe.concurrent(
  ...
  () => {
    ...
    it("should create 3 builds with no changes", async () => {
    ...
    it("should create 3 builds with changes then no changes", async () => {
    ...
    it("should create 3 builds with changes then back to the original", async () => {
      const snapshot1: CreateBuildOptions["snapshots"] = [
        {
          hash: nanoid(40),
          img: cleanEyePng,
    ...
    it("creates 3 builds each with decreasing number of snapshots", async () => {
      const snapshot1: CreateBuildOptions["snapshots"] = [
        {
          hash: nanoid(40),
          img: cleanEyePng,
