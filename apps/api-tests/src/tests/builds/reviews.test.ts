...
describe.concurrent(
  ...
  () => {
    ...
    it("should create 2 builds with changes, then approve all the snaps in the second build, then create a build with no changes", async () => {
    ...
    it("should create 2 builds with changes, then reject all the snaps in the second build, then create a build with the same changes, then a final build using the first snapshot", async () => {
      const snapshot1: CreateBuildOptions["snapshots"] = [
        {
          hash: nanoid(40),
          img: dirtyEyePng,
    ...
    it("should create 2 builds with no changes, then create a build with changes, then approve all snapshots", async () => {
      const snapshot1: CreateBuildOptions["snapshots"] = [
        {
          hash: nanoid(40),
          img: cleanEyePng,
    ...
    it("should create 2 builds with no changes, then create a build with changes, then reject 1 of the snapshots. The next build should also be rejected", async () => {
      const snapshot1: CreateBuildOptions["snapshots"] = [
        {
          hash: nanoid(40),
          img: cleanEyePng,
