...
describe.concurrent(
  ...
  () => {
    ...
    it("should create 3 builds which are all queued up asap", async () => {
    ...
    it("should create 3 builds which are all queued up asap and then back to the original", async () => {
      const snapshot1: CreateBuildOptions["snapshots"] = [
        {
          hash: nanoid(40),
          img: cleanEyePng,
