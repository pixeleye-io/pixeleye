...
-- Create enum type "team_member_type"
CREATE TYPE "public"."team_member_type" AS ENUM ('invited', 'git');
...
CREATE UNIQUE INDEX "idx_unique_team_external_id" ON "public"."team" ("external_id", "type");
...
CREATE TABLE "public"."team_users" ("team_id" character varying(255) NOT NULL, "user_id" character varying(21) NOT NULL, "role" "public"."team_member_role" NOT NULL, "type" "public"."team_member_type" NULL, CONSTRAINT "team_id" FOREIGN KEY ("team_id") REFERENCES "public"."team" ("id") ON UPDATE NO ACTION ON DELETE CASCADE, CONSTRAINT "user_id" FOREIGN KEY ("user_id") REFERENCES "public"."users" ("id") ON UPDATE NO ACTION ON DELETE CASCADE);
