...
CREATE TABLE "public"."diff_image" ("id" character(21) NOT NULL, "created_at" timestamptz NOT NULL, "hash" character varying(255) NOT NULL, "project_id" character(21) NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "project_id" FOREIGN KEY ("project_id") REFERENCES "public"."project" ("id") ON UPDATE NO ACTION ON DELETE CASCADE);
...
CREATE TABLE "public"."snap_image" ("id" character(21) NOT NULL, "created_at" timestamptz NOT NULL, "hash" character varying(255) NOT NULL, "project_id" character(21) NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "project_id" FOREIGN KEY ("project_id") REFERENCES "public"."project" ("id") ON UPDATE NO ACTION ON DELETE CASCADE);
