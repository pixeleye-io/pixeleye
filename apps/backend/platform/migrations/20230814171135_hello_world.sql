...
CREATE TABLE "public"."project" ("id" character varying(21) NOT NULL, "created_at" timestamptz NOT NULL, "updated_at" timestamptz NOT NULL, "team_id" character varying(21) NOT NULL, "name" character varying(255) NOT NULL, "url" text NOT NULL, "source" "public"."project_source" NOT NULL, "source_id" character varying(255) NOT NULL, "token" character varying(255) NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "team_id" FOREIGN KEY ("team_id") REFERENCES "public"."team" ("id") ON UPDATE NO ACTION ON DELETE CASCADE);
-- Create "build" table
CREATE TABLE "public"."build" ("id" character varying(21) NOT NULL, "created_at" timestamptz NOT NULL, "updated_at" timestamptz NOT NULL, "project_id" character varying(21) NOT NULL, "target_parent_id" character varying(21) NOT NULL, "build_number" integer NOT NULL DEFAULT 0, "status" "public"."build_status" NOT NULL DEFAULT 'uploading', "target_build_id" character varying(21) NOT NULL, "sha" character varying(255) NOT NULL, "branch" character varying(255) NOT NULL, "message" character varying(255) NOT NULL, "title" character varying(255) NOT NULL, "warnings" text[] NULL, "errors" text[] NULL, "deleted_snapshot_ids" text[] NULL, "approved_by" character varying(21) NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "project_id" FOREIGN KEY ("project_id") REFERENCES "public"."project" ("id") ON UPDATE NO ACTION ON DELETE CASCADE);
...
CREATE TABLE "public"."snap_image" ("id" character varying(21) NOT NULL, "created_at" timestamptz NOT NULL, "hash" character varying(64) NOT NULL, "project_id" character varying(21) NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "project_id" FOREIGN KEY ("project_id") REFERENCES "public"."project" ("id") ON UPDATE NO ACTION ON DELETE CASCADE);
...
CREATE TABLE "public"."project_users" ("project_id" character varying(21) NOT NULL, "user_id" character varying(255) NOT NULL, "role" "public"."project_member_role" NOT NULL, CONSTRAINT "project_id" FOREIGN KEY ("project_id") REFERENCES "public"."project" ("id") ON UPDATE NO ACTION ON DELETE CASCADE);
-- Create "diff_image" table
CREATE TABLE "public"."diff_image" ("id" character varying(21) NOT NULL, "created_at" timestamptz NOT NULL, "hash" character varying(64) NOT NULL, "project_id" character varying(21) NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "project_id" FOREIGN KEY ("project_id") REFERENCES "public"."project" ("id") ON UPDATE NO ACTION ON DELETE CASCADE);
