...
CREATE TABLE "public"."project" ("id" character(21) NOT NULL, "created_at" timestamptz NOT NULL, "updated_at" timestamptz NOT NULL, "name" character varying(255) NOT NULL, "url" text NOT NULL, "source" "public"."project_source" NOT NULL, "source_id" character varying(255) NULL, "token" character varying(255) NULL, PRIMARY KEY ("id"));
-- Create "build" table
CREATE TABLE "public"."build" ("id" character(21) NOT NULL, "created_at" timestamptz NOT NULL, "updated_at" timestamptz NOT NULL, "project_id" character(21) NOT NULL, "build_number" integer NOT NULL DEFAULT 0, "status" "public"."build_status" NOT NULL DEFAULT 'uploading', "sha" character varying(255) NOT NULL, "branch" character varying(255) NOT NULL, "message" character varying(255) NULL, "title" character varying(255) NULL, "errors" text[] NULL, PRIMARY KEY ("id"), CONSTRAINT "project_id" FOREIGN KEY ("project_id") REFERENCES "public"."project" ("id") ON UPDATE NO ACTION ON DELETE CASCADE);
...
CREATE TABLE "public"."diff_image" ("id" character(21) NOT NULL, "hash" character varying(255) NOT NULL, "project_id" character(21) NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "project_id" FOREIGN KEY ("project_id") REFERENCES "public"."project" ("id") ON UPDATE NO ACTION ON DELETE CASCADE);
...
CREATE TABLE "public"."snap_image" ("id" character(21) NOT NULL, "hash" character varying(255) NOT NULL, "project_id" character(21) NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "project_id" FOREIGN KEY ("project_id") REFERENCES "public"."project" ("id") ON UPDATE NO ACTION ON DELETE CASCADE);
