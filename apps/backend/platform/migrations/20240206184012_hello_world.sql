...
CREATE TABLE "public"."project" ("id" character varying(21) NOT NULL, "created_at" timestamptz NOT NULL, "updated_at" timestamptz NOT NULL, "team_id" character varying(21) NOT NULL, "name" character varying(255) NOT NULL, "url" text NOT NULL, "source" "public"."project_source" NOT NULL, "source_id" character varying(255) NOT NULL, "token" character varying(255) NOT NULL, "auto_approve" character varying(255) NOT NULL DEFAULT '', "snapshot_threshold" double precision NOT NULL DEFAULT 0.2, "snapshot_blur" boolean NOT NULL DEFAULT false, "build_count" integer NOT NULL DEFAULT 0, PRIMARY KEY ("id"), CONSTRAINT "team_id" FOREIGN KEY ("team_id") REFERENCES "public"."team" ("id") ON UPDATE NO ACTION ON DELETE CASCADE);
-- Create "build" table
