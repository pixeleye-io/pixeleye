...
import type { Build } from "@pixeleye/api"
import { type BuildAPI, type ExtendedSnapshotPair, Reviewer } from "@pixeleye/reviewer"
...
export default function InteractiveReviewer({
    ...
    return (
        <Reviewer
            ...
            buildAPI={buildAPI}
            optimize
            navigate={(url) => { if (window.location.href.replace(window.location.origin, "") !== url) { window.history.replaceState({}, '', url) } }}
