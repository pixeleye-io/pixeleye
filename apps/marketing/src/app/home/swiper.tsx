      ...
      <div className="-m-2 rounded-xl bg-surface-container-highest/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4 ">
        ...
        >
          ...
          >
            ...
            >
              <div className="absolute flex justify-between w-36 top-8 translate-x-1">
                <p className="bg-surface-container-highest rounded-full border border-outline-variant text-sm text-on-surface px-2 py-1">
                  After
                </p>
                <p className="bg-surface-container-highest rounded-full border border-outline-variant text-sm text-on-surface px-2 py-1">
                  Before
