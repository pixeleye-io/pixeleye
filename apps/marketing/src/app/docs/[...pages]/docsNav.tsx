...
export function DocsNavMobile({ sections }: DocsNavProps) {
  ...
  return (
    <Collapsible.Root onOpenChange={onOpenChange} className="bg-surface/90 backdrop-blur-sm fixed w-full inset-x-0 top-16 data-[state=open]:bottom-0">
      ...
      <Collapsible.Content className="fixed lg:hidden w-full max-h-[calc(100vh-8rem)] overflow-y-auto px-6 py-4 ">
