...
var require_util = __commonJS({
  "../../node_modules/.pnpm/superjson@1.12.2/node_modules/superjson/dist/util.js"(exports) {
    ...
    function forEach(record, run) {
      Object.entries(record).forEach(function(_a4) {
        var _b = __read(_a4, 2), key = _b[0], value = _b[1];
...
var require_plainer = __commonJS({
  "../../node_modules/.pnpm/superjson@1.12.2/node_modules/superjson/dist/plainer.js"(exports) {
    ...
    function traverse(tree, walker2, origin) {
      ...
      var _a4 = __read(tree, 2), nodeValue = _a4[0], children = _a4[1];
      if (children) {
    ...
    function applyReferentialEqualityAnnotations(plain, annotations) {
      ...
      if (is_1.isArray(annotations)) {
        var _a4 = __read(annotations, 2), root = _a4[0], other = _a4[1];
    ...
    function generateReferentialEqualityAnnotations(identitites) {
      ...
      identitites.forEach(function(paths) {
        ...
        var _a4 = __read(paths.map(function(path) {
          return path.map(String);
        }).sort(function(a, b) {
          return a.length - b.length;
        })), shortestPath = _a4[0], identicalPaths = _a4.slice(1);
...
// ../../node_modules/.pnpm/is-what@4.1.8/node_modules/is-what/dist/index.cjs
var require_dist = __commonJS({
  "../../node_modules/.pnpm/is-what@4.1.8/node_modules/is-what/dist/index.cjs"(exports) {
    "use strict";
...
// ../../node_modules/.pnpm/copy-anything@3.0.3/node_modules/copy-anything/dist/index.cjs
var require_dist2 = __commonJS({
  "../../node_modules/.pnpm/copy-anything@3.0.3/node_modules/copy-anything/dist/index.cjs"(exports) {
    "use strict";
    var isWhat = require_dist();
    ...
    subscribe(observer) {
      ...
      teardownRef = subscribe({
        next(value) {
          ...
          (_a4 = observer.next) == null ? void 0 : _a4.call(observer, value);
        },
        error(err) {
          var _a4;
          if (isDone) {
          ...
          isDone = true;
          (_a4 = observer.error) == null ? void 0 : _a4.call(observer, err);
          unsubscribe();
        },
        complete() {
          var _a4;
          ...
          isDone = true;
          (_a4 = observer.complete) == null ? void 0 : _a4.call(observer);
          unsubscribe();
        }
      });
    ...
    function startIfNeeded() {
      ...
      subscription = originalObserver.subscribe({
        ...
        error(error) {
          var _a4;
          for (const observer of observers) {
            (_a4 = observer.error) == null ? void 0 : _a4.call(observer, error);
          }
        },
        complete() {
          var _a4;
...
var TRPCClientError = class extends Error {
  ...
  constructor(message, opts) {
    ...
    this.cause = cause;
    this.shape = (_a4 = opts == null ? void 0 : opts.result) == null ? void 0 : _a4.error;
...
function dataLoader(batchLoader) {
  ...
  function load(key) {
    ...
    const cancel = () => {
      var _a4;
      item.aborted = true;
      if ((_a4 = item.batch) == null ? void 0 : _a4.items.every((item2) => item2.aborted)) {
        item.batch.cancel();
        item.batch = null;
      }
    };
...
var TRPCUntypedClient = class {
  ...
  requestAsPromise(opts) {
    ...
    const abortablePromise = new Promise((resolve, reject) => {
      var _a4;
      (_a4 = opts.signal) == null ? void 0 : _a4.addEventListener("abort", abort);
    ...
    return observable$.subscribe({
      next(envelope) {
        ...
        if (envelope.result.type === "started") {
          (_a4 = opts.onStarted) == null ? void 0 : _a4.call(opts);
      ...
      error(err) {
        var _a4;
        (_a4 = opts.onError) == null ? void 0 : _a4.call(opts, err);
      },
      complete() {
        var _a4;
        (_a4 = opts.onComplete) == null ? void 0 : _a4.call(opts);
      }
    });
  }
  constructor(opts) {
    ...
    function getTransformer() {
      const transformer2 = opts.transformer;
      if (!transformer2)
        return {
          serialize: (data) => data,
          deserialize: (data) => data
        };
      if ("input" in transformer2)
        return {
          serialize: transformer2.input.serialize,
          deserialize: transformer2.output.deserialize
        };
      return transformer2;
    }
    this.runtime = {
...
}).action(upload_default).configureOutput({
  outputError: (str, write) => write(source_default.red(str))
});
var commands_default = program.parse(process.argv);
export {
